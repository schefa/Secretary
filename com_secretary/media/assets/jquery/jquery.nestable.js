...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            ...
            $.each(this.el.find('.' + list.options.itemClass), function(k, el) {
                list.setParent($(el));
            });
            ...
            list.el.on('click', 'button', function(e) {
                ...
                var target = $(e.currentTarget),
                    ...
                    item   = target.parent('.' + list.options.itemClass);
                if (action === 'collapse') {
        ...
        serialize: function()
        {
            ...
            data = step(list.el.find('.' + list.options.listClass).first(), depth);
            return data;
        },
        ...
        expandItem: function(li)
        {
            ...
            li.children('.' + this.options.listClass).show();
        },
        ...
        collapseItem: function(li)
        {
            ...
            if (lists.length) {
                ...
                li.children('.' + this.options.listClass).hide();
            }
        },
        ...
        {
            var list = this;
            list.el.find('.' + list.options.itemClass).each(function() {
        ...
        dragStart: function(e)
        {
            ...
            var i, depth,
                items = this.dragEl.find('.' + this.options.itemClass);
