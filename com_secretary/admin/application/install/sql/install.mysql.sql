...
CREATE TABLE IF NOT EXISTS `#__secretary_businesses` (
  ...
  `address` mediumtext,
  `vatid` varchar(50) NULL DEFAULT NULL,
  `upload` varchar(30) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__secretary_documents` (
  ...
  `taxtotal` varchar(255) NULL DEFAULT NULL,
...
(8, 'system', 'COM_SECRETARY_FIELD_URL', 'COM_SECRETARY_FIELD_URL_DESC', 'url', 'url', '', 'https://github.com/schefa/Secretary', 0),
...
(1, 0, 0, 'system', 0, 1, 0, 0, 'ROOT', '', '', NULL, '', 0, NULL, 601, '2011-01-01 00:00:01', 1);
...
CREATE TABLE IF NOT EXISTS `#__secretary_products` (
  ...
  `priceCost` decimal(15,4) NULL DEFAULT NULL,
  `priceSale` decimal(15,4) NULL DEFAULT NULL,
  `quantityBought` decimal(15,4) NULL DEFAULT NULL,
  `quantityMax` decimal(15,4) NULL DEFAULT NULL,
  `quantityMin` decimal(15,4) NULL DEFAULT NULL,
  `quantity` decimal(15,4) NULL DEFAULT NULL,
  `totalBought` decimal(15,4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__secretary_times` (
  ...
  `contacts` text NOT NULL,
  `maxContacts` int(8) NOT NULL DEFAULT '0',
  `startDate` datetime NULL DEFAULT NULL,
  `endDate` datetime NULL DEFAULT NULL,
  `created_by` int(11) NOT NULL,
  `created` datetime NOT NULL,
