...
class SecretaryControllerDocument extends \Joomla\CMS\MVC\Controller\FormController
{
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($this->subject)
		{
			...
			$this->setMessage(\Joomla\CMS\Language\Text::sprintf('COM_SECRETARY_DOCUMENTS_X_CREATED', count($subjects ?? [])));
		}
        ...
        if ($task == 'save')
		{
			$this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=' . $this->view_list . '&catid=' . $this->catid, false));
		}
	}
