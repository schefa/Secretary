...
class SecretaryControllerTime extends \Joomla\CMS\MVC\Controller\FormController
{
	...
	public function batch($model = null)
	{
		...
		$this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=times' . $this->getRedirectToListAppend(), false));
	}
	...
	public function subscription()
	{
		...
		$this->setMessage($msg);
		$this->setRedirect(\Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=time&id=' . $id . '&extension=' . $this->extension, false));
