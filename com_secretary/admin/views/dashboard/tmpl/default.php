    ...
    <div class="dashboard-icons fullwidth">
        ...
        <div class="fullwidth">
            ...
            <div class="col-md-3">
                <a class="icon" href="index.php?option=com_secretary&view=folders&extension=documents">
                    ...
                    <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FOLDERS'); ?>
                </a>
            </div>
            <?php } ?>
        ...
        <div class="fullwidth">
            ...
            <div class="col-md-3">
                ...
                <span class="fa fa-home"></span><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_BUSINESS'); ?>
                </a>
            </div>
            <?php } ?>
            ...
            <?php if ($user->authorise('core.show', 'com_secretary.location'))
            {
                ?>
            <div class="col-md-3">
                    <a class="icon" href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=locations'); ?>">
            ...
            <div class="col-md-3">
                ...
                <span class="fa fa-upload"></span><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FILES'); ?>
                </a>
            </div>
...
<div class="secretary-main-area"> 
    <div class="secretary-activities">
        ...
        <form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=dashboard'); ?>" method="post" name="adminForm" id="adminForm">
    
            <h2 class="documents-title">
			<?php
			echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_ACTIVITY'); 
                ...
                <table class="table table-hover" id="documentsList">
                    <thead>
                        <tr>
                            ...
                            <?php } ?>
                            <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_DATE', 'a.created', $listDirn, $listOrder); ?></th> 
                            <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_ACTIVITY', 'a.id', $listDirn, $listOrder); ?></th>
                            <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_SECTION', 'a.extension', $listDirn, $listOrder); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="row<?php echo $i % 2 ; ?>">
                            ...
                            <td class="center hidden-phone">
                                <?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.id', $i, $activity->id); ?>
                                <span class="lbl"></span>
                            </td>
                            <?php } ?>
                            
                            <td class="left"> <?php echo \Joomla\CMS\HTML\HTMLHelper::_('date', $activity->created, \Joomla\CMS\Language\Text::_('DATE_FORMAT_LC2'));?> </td>
                            
                            <td class="left"> <?php echo \Secretary\Helpers\Activity::get($activity->id); ?> </td>
                            
                            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_'.strtoupper($activity->extension)); ?></td>
            ...
            {
                echo '<div class="">'.\Joomla\CMS\Language\Text::_('COM_SECRETARY_NONE').'</div>'; } ?>
