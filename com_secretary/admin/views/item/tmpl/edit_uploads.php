...
else
{
    ...
    <div class="upload-allowedsize"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT_SIZE_ALLOWED') .' '. \Secretary\Utilities\Number::human_filesize($this->state->params->get('documentSize')) . 'B'; ?></div>
<?php } ?>
