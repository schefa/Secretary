...
?>
<h2 class="times-week">
    <a class="btn btn-default" href="<?php echo Secretary\Route::create('times', array('week' => $backweek, 'section' => 'week')); ?>"><?php echo \Joomla\CMS\Language\Text::_('JPREV'); ?></a>
    <span><?php echo $this->week . '.  ' . \Joomla\CMS\Language\Text::_('COM_SECRETARY_CALENDARWEEK'); ?></span>
    <a class="btn btn-default" href="<?php echo Secretary\Route::create('times', array('week' => $nextweek, 'section' => 'week')); ?>"><?php echo \Joomla\CMS\Language\Text::_('JNEXT'); ?></a>
</h2>
<div class="week-view clearfix">
    ...
    for ($day = 1; $day <= 7; $day++)
    {
        ...
        <div class="week">
            <div class="week-head">
                <h3><?php echo \Joomla\CMS\Language\Text::_(\Secretary\Helpers\Times::getWeekDayname($day)); ?></h3>
