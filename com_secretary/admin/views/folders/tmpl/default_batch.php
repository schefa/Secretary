...
<template id="secretary-batch-dialog">
    ...
    <div class="secretary-modal-bottom">
            <button class="btn" type="button" onclick="document.getElementById('batch-folder-id').value='';document.getElementById('batch-access').value='';document.getElementById('batch-language-id').value='';this.closest('joomla-dialog').close();">
