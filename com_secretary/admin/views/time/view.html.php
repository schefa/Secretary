...
class SecretaryViewTime extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	protected $item;
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		{
			case 'tasks':
				$this->title		= \Joomla\CMS\Language\Text::_('COM_SECRETARY_TASK');
			...
			default :
				$this->title	= \Joomla\CMS\Language\Text::_('COM_SECRETARY_'.substr($this->extension,0,-1));
				break;
