...
<ul class="nav nav-tabs fullwidth" id="myTab" role="tablist">
    ...
    <li class="nav-item"><a href="#details" role="tab" data-bs-toggle="tab" class="nav-link"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TAB_ERWEITERT', true); ?></a></li>
    <?php 
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="home">
        ...
        <div class="row">
                ...
                <div class="row-fluid">
                    ...
                    <div class="col-md-3">
                        ...
                        <select type="text" name="jform[projectID]" >
                            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $this->projects['items'], 'value', 'text', $this->projects['default'] , true); ?>
                        </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TEAM'); ?></label></div>
                            <div class="posts multiple-input-selection clearfix" data-counter="<?php echo $this->contactsCounts; ?>">
                                <div>
                                <input class="search-features" type="text" placeholder="<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SEARCH'); ?>" >
                                </div>
                            </div>
                        </div>
                        <hr class="fullwidth" />
            ...
            <div class="repetition-container clearfix <?php if ($this->item->repetition['check'] == 1)
            {
                echo 'out';}?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="secretary-input-group clearfix">
                                ...
                                <div class="secretary-input-group-right currency-control"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_HOURS'); ?></div>
                            </div>
                        </div>
                    </div>
