        ...
        <div class="fullwidth">
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PROJECT'); ?></label></div>
                ...
                <div class="fullwidth">
                    ...
                    <div class="control-group"> 
                        <div class="fullwidth margin-bottom projectTimer" data-item="<?php echo $this->item->id; ?>" data-project="<?php echo $this->item->projectID; ?>">
                            ...
                            if ($this->projectTimer->action == "start")
                            {
                                echo 'style="display:none;"';
                            } ?>  data-task="start"><i class="fa fa-play"></i></a>
                            <a class="btn btn-large" <?php 
                            if ($this->projectTimer->action != 'start')
                            {
                                                    echo 'style="display:none;"';
                            } ?> data-task="stop"><i class="fa fa-pause"></i></a>
                        </div>
                    </div>
                                        <?php } ?>
                    ...
                    <div class="control-group">
                        ...
                        <?php if ($this->canDo->get('core.edit'))
                        {
                            ...
                            <div class="secretary-control-group input-range">
                                ...
                                <div class="input-range-save btn btn-small btn-default" data-id="<?php echo $this->item->id; ?>" data-extension="tasks" style="display:none;"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SAVE');?></div>
                            </div>
                        <?php }
                        else
                        {
...
(function($){
	...
	$('.input-range-save').click(function(){
		if($(this).is(':visible')) {
			...
			$.ajax({
				url: "index.php?option=com_secretary&task=ajax.saveProgress&value=" + value + "&id=" + id + "&extension=" + extension + "&" + Joomla.getOptions('csrf.token') + "=1",
				type: 'get',
