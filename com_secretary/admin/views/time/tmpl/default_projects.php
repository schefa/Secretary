...
<ul class="nav nav-tabs fullwidth" id="myTab" role="tablist">
    ...
    <li class="nav-item"><a href="#tasks" role="tab" data-bs-toggle="tab" class="nav-link"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TASKS', true); ?></a></li>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="controls"><?php echo \Joomla\CMS\Language\Text::_($category); ?></div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        if (!empty($document) && $this->item->document_id > 0)
                        {
                            echo '<a href="index.php?option=com_secretary&view=document&id='.$this->item->document_id .'">'
                                . $document['value'] .'</a>'
                                . '<br>'.\Joomla\CMS\Language\Text::_('COM_SECRETARY_BUDGET') . ': '
                        ...
                        elseif ($user->authorise('com_secretary','time.'.$this->item->id))
                        {
                            ?> 
                                ...
                                {
                                    $options[] = \Joomla\CMS\HTML\HTMLHelper::_('select.option', $document->id, \Joomla\CMS\Language\Text::_($document->title)); }
                                ?>
                                <div class="select-arrow select-arrow-white">
                                <select id="add_new_document">
                                    <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $options, 'value', 'text');?>
                                </select>
                                </div>
