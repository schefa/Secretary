...
<div class="btn-toolbar-charts fullwidth">
    ...
    <div class="item-stats pull-right">
        ...
        <select class="form-control" name="filter_cont_state">
            ...
            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $this->contStates, 'value', 'text', $this->state->get('filter.contstate'), true);?>
        </select> 
        </div> 
    </div>
...
<div class="row-fluid fullwidth">
    <div class="col-md-12">
        <h3><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_CHARTS_NEW_CONTACTS");?></h3>
        <div id="secretary-chart-contacts-growth" class="secretary-charts" style="width:100%;"></div>
        <hr>
        <div class="col-md-12">
            <div class="col-md-4">
        	<h3><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_ANREDE");?></h3>
            <div id="secretary-chart-contacts-genders" class="secretary-charts"></div>
            </div>
            <div class="col-md-4">
        	<h3><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_CATEGORIES_SUBJECTS");?></h3>
            <div id="secretary-chart-contacts-categories" class="secretary-charts"></div>
            </div>
            <div class="col-md-4">
        	<h3><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_LOCATION");?></h3>
