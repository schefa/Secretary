...
<div class="form-group">
    ...
    <div class="secretary-template-margins secretary-control-group">
        ...
        <h4 class="secretary-tooltip"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_MARGINS'); ?>&nbsp;<i class="fa fa-question-circle"></i>
          <span class="tooltip-toggle"><img src="<?php echo SECRETARY_MEDIA_PATH; ?>/images/margins.png" /></span>
        </h4>

    	<div class="secretary-input-prepend">
            <div class="secretary-add-on"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_LEFT'); ?></div>
    		<input name="jform[margins][0]" type="number" min="0" step="1" value="<?php echo $this->item->margins[0] ?? ''; ?>" />
            <div class="secretary-add-on">mm</div>
        </div>
    	<div class="secretary-input-prepend">
            <div class="secretary-add-on"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_RIGHT'); ?></div>
    		<input name="jform[margins][1]" type="number" min="0" step="1" value="<?php echo $this->item->margins[1] ?? ''; ?>" />
            <div class="secretary-add-on">mm</div>
        </div>
    	<div class="secretary-input-prepend">
            <div class="secretary-add-on"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOP'); ?></div>
    		<input name="jform[margins][2]" type="number" min="0" step="1" value="<?php echo $this->item->margins[2] ?? ''; ?>" />
            <div class="secretary-add-on">mm</div>
        </div>
    	<div class="secretary-input-prepend">
            <div class="secretary-add-on"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_BOTTOM'); ?></div>
...
<div id="secretary-template-designer-options" style="display:none;">
    ...
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_RESOLUTION'); ?></h4>
	...
	<div class="secretary-designer-hr"></div>
    <div class="add-box btn btn-newentry btn-default" data-type="textarea"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TEMPLATE_DESIGNER_ADD_BOX'); ?></div>
	<div class="secretary-designer-hr"></div>
	
<div class="secretary-designer-fields-desc"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TEMPLATE_DESIGNER_MOVE_FIELDS'); ?></div>
</div>
    
<div class="form-group">
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FIELDS'); ?></h4>
    <div class="nav">
    ...
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_USER_CONTACT'); ?></h4>
    <div class="nav">
        <div><div class="secretary-desc"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_USER_CONTACT_DESC') ?></div></div>
    ...
    ?>
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FIELDS').' - '. \Joomla\CMS\Language\Text::_('COM_SECRETARY_BUSINESS').' & '. \Joomla\CMS\Language\Text::_('COM_SECRETARY_CATEGORIES');?></h4>
    <?php
...
<?php if ($this->item->extension === 'documents' || $this->item->extension === 'subjects')
{
    ?>
<div class="form-group">
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SUBJECT'); ?></h4>
    <div class="nav">
...
<?php }
elseif ($this->item->extension === 'products')
{
    ?>
<div class="form-group">
    <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT'); ?></h4>
    <div class="nav">
...
<?php if ($this->item->extension === 'documents')
{
    ?>
    <div class="form-group">
        <h4><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT'); ?></h4>
        <div class="nav">
    ...
    <div class="form-group">
        <h4 class="secretary-drag-fields-items"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT') .' - '. \Joomla\CMS\Language\Text::_('COM_SECRETARY_LIST'); ?></h4>
        <div class="nav">
