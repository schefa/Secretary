...
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=language'); ?>" 
...
<div class="secretary-main-area">
	...
	<div class="fullwidth">
		<div class="pull-left">
			...
			<span class="documents-title-first"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATIONS')?></span>
			</h2>
		</div>
		<div class="pull-right">
			...
			<button onclick="document.getElementById('filter_search').value='';this.form.submit();" class="btn"><?php echo \Joomla\CMS\Language\Text::_( 'COM_SECRETARY_RESET' ); ?></button>
			</div>
		</div>
	</div>
	...
	<div class="fullwidth clearfix margin-bottom">
		<div class="pull-left">
			<button class="btn btn-default btn-newentry" type="submit" name="task" value="language.save"><i class="fa fa-save"></i> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOOLBAR_APPLY')?></button> 
			<button class="btn btn-default" type="submit" name="task" value="language.share"><i class="fa fa-heart"></i> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATIONS_SHARE')?></button> 
		</div> 
        <div class="pull-right select-arrow-control margin-right">
        	<span class="select-label"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATIONS_SELECT_LANGUAGE')?></span>
	...
	<table class="table-hover" id="secretary-language-table">
		<tr>
			...
			<th class="left" style="width:45%;"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATIONS_KEY')?> / <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATIONS_ORIGINAL')?></th>
			<th class="left" style="width:50%;"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TRANSLATION')?></th>
		</tr>		
		<?php
		$x = 1;
