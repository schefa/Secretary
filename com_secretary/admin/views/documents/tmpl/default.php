...
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=documents'.$category); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="fullwidth">
        ...
        <div class="secretary-main-container-left">
            ...
            <div class="secretary-main-area">
				<div class="alert alert-warning"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PDF_MISSING_PLUGIN');?></div>
            </div>
			<?php } ?>
            ...
            <div class="secretary-main-area">
                ...
                <div class="fullwidth clearfix">
                    ...
                    <div class="secretary-search btn-group">
                        <input type="text" class="form-control" name="filter_search" id="filter_search" placeholder="<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SEARCH_DOCUMENTS_VIEW'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SEARCH_DOCUMENTS_VIEW'); ?>" />
                ...
                <table class="table table-hover" id="documentsList">
                    <thead>
                        <tr>
                            ...
                            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort','COM_SECRETARY_NR', 'a.nr', $listDirn, $listOrder); ?>
                            </th>
                            <th width="1%" class='center'>
                            </th>
                            <th width="1%">
                            ...
                            <th class='left'>
                            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_DATE', 'a.created', $listDirn, $listOrder) ." / ". \Joomla\CMS\HTML\HTMLHelper::_('grid.sort','COM_SECRETARY_FOLDER', 'a.catid', $listDirn, $listOrder) ; ?>
                            </th> 
                            <th class='left'>
                            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_SUBJECT', 'contact_name', $listDirn, $listOrder); ?>
                            </th>
                            <th class='right'>
                            <?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort',  'COM_SECRETARY_TOTAL', 'a.total', $listDirn, $listOrder); ?>
                            </th>
        ...
        <div class="secretary-main-container-right">
            ...
            <div class="row-fluid">
                <h3 class="documents-sidebar-title"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FILTER'); ?><button class="btn headline-sidebar-button" type="submit"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FILTER_DATE_GO'); ?></button></h3>
                <div class="filter-date clearfix">
                    <label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FILTER_DATE_START'); ?></label>
                    <?php echo \Joomla\CMS\HTML\HTMLHelper::_('calendar', $this->state->get('start_date'), 'start_date', 'start_date', "%Y-%m-%d", array('class'=>'form-control input-date')); ?>
                </div>
                <div class="filter-date clearfix">
                    <label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FILTER_DATE_END'); ?></label>
                    <?php echo \Joomla\CMS\HTML\HTMLHelper::_('calendar', $this->state->get('end_date'), 'end_date', 'end_date', "%Y-%m-%d", array('class'=>'form-control input-date')); ?>
                </div>
            </div>   
            <?php } ?>
            ...
            <div class="row-fluid">
            	<div class="select-arrow">
                    <select id="documents_office" class="reloadSite">
                        <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $this->locations, 'id', 'title', $this->locationId, true);?>
                    </select>
				</div>   
				<?php 
				$currencyTitle = \Joomla\CMS\Language\Text::_('COM_SECRETARY_CURRENCIES');
				$currOptions[] = \Joomla\CMS\HTML\HTMLHelper::_('select.option', 0, \Joomla\CMS\Language\Text::sprintf('COM_SECRETARY_FILTER_SELECT_LABEL_ALL', $currencyTitle) );
				
                foreach ($this->report['currencies'] as $cur)
                {
				    $currOptions[] = \Joomla\CMS\HTML\HTMLHelper::_('select.option', $cur, $cur );
                }
				?>
            	<div class="select-arrow">
                    <select id="documents_currency" class="reloadSite">
                        <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $currOptions, 'value', 'text', $this->currencyId );?>
                    </select>
				</div>
            	<div class="select-arrow">
            ...
            <div class="row-fluid">
                ...
                <?php if (!empty($this->itemsRepeat))
                   ...
                   <a class="btn headline-sidebar-button"
                   data-joomla-dialog='{"popupType": "iframe", "src": "<?php echo Secretary\Route::create('documents', array('layout'=>'repetition','tmpl'=>'component')); ?>"}' >
                   <i class="fa fa-share-square-o"></i> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SHOW'); ?>
                   </a>
                   </div>
                <?php }
                    else
