...
class SecretaryViewDocuments extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->locations	= \Joomla\CMS\Form\FormHelper::loadFieldType('Locations', false)->getLocations($this->view);
	...
	protected function addToolbar()
	{
		...
		$addEntryText = \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT');
		
        if (!empty($this->report['alias']))
		{
			$addEntryText = \Joomla\CMS\Language\Text::sprintf('COM_SECRETARY_NEW_ENTRY_TOOLBAR', $this->report['alias']);
		}
        else
		{
			$addEntryText = \Joomla\CMS\Language\Text::sprintf('COM_SECRETARY_NEW_ENTRY_TOOLBAR', $addEntryText);
		}
	...
	{
		return array(
			'a.nr' => \Joomla\CMS\Language\Text::_('COM_SECRETARY_NR'),
			'a.created' => \Joomla\CMS\Language\Text::_('COM_SECRETARY_DATE'),
			'contact_name' => \Joomla\CMS\Language\Text::_('COM_SECRETARY_SUBJECT'),
			'a.catid' => \Joomla\CMS\Language\Text::_('COM_SECRETARY_FOLDER'),
			'a.state' => \Joomla\CMS\Language\Text::_('JSTATUS'),
			'a.total' => \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOTAL')
		);
	}
