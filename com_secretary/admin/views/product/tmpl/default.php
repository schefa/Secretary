...
<div class="secretary-main-area entry-default">
    ...
    <div class="secretary-toolbar fullwidth">
        <div class="secretary-title">
            <span><a href="<?php echo Secretary\Route::create('products'); ?>"> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCTS'); ?></a>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span>
            <span><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT'); ?></span>
            
			<?php if ($this->checkedOut == false && (\Secretary\Helpers\Access::edit('product',$this->item->id,$this->item->created_by)))
			{
                ?>
            <a class="btn btn-saveentry" href="index.php?option=com_secretary&task=product.edit&id=<?php echo $this->item->id;?>&catid=<?php echo $this->item->catid;?>"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOOLBAR_EDIT'); ?></a>
			<?php } ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="home">
            ...
            <div class="row-fluid">
                <div class="col-md-6">
                    <h3 class="title title-edit"><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_EINGANG"); ?></h3>
                    <div class="control-group">
                ...
                <div class="col-md-6">
                    <h3 class="title title-edit"><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_AUSGANG"); ?></h3>
                    <div class="control-group">
