...
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=product&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
	...
	<div class="secretary-main-area">
        ...
        <div class="secretary-toolbar fullwidth">
            ...
            <span>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT'); ?></span>
            <?php $this->addToolbar(); ?>
            </div>
        </div>
        ...
        <ul class="nav nav-tabs fullwidth" id="myTab" role="tablist">
            ...
            <li class="nav-item"><a href="#history" role="tab" data-bs-toggle="tab" class="nav-link"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENTS', true); ?></a></li>
            ...
            <li class="nav-item pull-right secretary-document-pdf-print">
                <a class="btn btn-link btn-pdf" data-joomla-dialog='{"popupType": "iframe", "src": "<?php echo Secretary\Route::create('product', array('format'=>'pdf', 'id'=> $this->item->id )); ?>"}'><img src="<?php echo SECRETARY_MEDIA_PATH; ?>/images/pdf-20.png" />&nbsp;<?php echo 'PDF'; ?></a>
            </li>
            <?php }  ?>
        </ul>
               	...
               	<div class="fullwidth">
                	...
                	<div class="form-horizontal row-fluid">
                        <div class="col-md-6">
							...
							<?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_EINGANG"); ?> 
                            <a class="btn btn-sm" href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=document&layout=edit&pusage=2&pid='.$this->item->id . '&subject='.json_encode($this->suppliers_ids));?>"><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_BUY"); ?></a>
                            </h3>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT_QUANTITYBOUGHT'); ?></label></div>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT_TOTALBOUGHT'); ?></label></div>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SUPPLIERS'); ?>&nbsp;<a href="index.php?option=com_secretary&view=subjects" target="_blank"><i class="fa fa-external-link"></i></a></label></div>
                                <div class="controls">
                        ...
                        <div class="col-md-6">
                            <h3 class="title title-edit"><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_AUSGANG"); ?>
                            <a class="btn btn-sm" href="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=document&layout=edit&pusage=1&pid='.$this->item->id);?>"><?php echo \Joomla\CMS\Language\Text::_("COM_SECRETARY_SELL"); ?></a>
                            </h3>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT_QUANTITY'); ?></label></div>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT_TOTAL'); ?></label></div>
                                <div class="controls">
