...
class SecretaryViewProduct extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	protected $item;
	protected $form;
	...
	public function display($tpl = null)
	{
        ...
        $this->itemtemplates = \Joomla\CMS\Form\FormHelper::loadFieldType('templates',false)->getList($this->item->template,'jform[template]','', array('products'));
