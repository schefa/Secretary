...
class SecretaryViewFolder extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $form;
	protected $item;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$this->getJS();
		$this->title = \Joomla\CMS\Language\Text::_('COM_SECRETARY_CATEGORY') . ': ' . \Joomla\CMS\Language\Text::_('COM_SECRETARY_' . strtoupper($this->extension ?? ''));
		...
		if ($this->item->extension == 'documents')
		{
			...
			$this->emailtemplates	   =	\Joomla\CMS\Form\FormHelper::loadFieldType('templates', false)->getList($this->item->emailtemplate, 'jform[fields][emailtemplate]', 'fullwidth');
		}

		if (in_array($this->item->extension, array('documents', 'subjects', 'products')))
		{
			$this->itemtemplates		=	\Joomla\CMS\Form\FormHelper::loadFieldType('templates', false)->getList($this->item->template, 'jform[fields][template]', 'fullwidth', array($this->item->extension));
		}
	...
	private function getCategories()
	{
		...
		$categories = \Joomla\CMS\Form\FormHelper::loadFieldType('Categories', false)->getCategories($this->extension, $this->item->id);
