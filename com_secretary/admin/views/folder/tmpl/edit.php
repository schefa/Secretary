...
<div class="secretary-main-container">
    ...
    <form
        action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=folder&extension=' . $this->extension . '&layout=edit&id=' . (int) $this->item->id); ?>"
        method="post" name="adminForm" id="adminForm" class="form-validate">
        <div class="secretary-main-area">
            <div class="secretary-toolbar fullwidth">
                <div class="secretary-title">
                    <span>
                        <?php echo \Joomla\CMS\Language\Text::_($this->title); ?>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;
                    </span>
                    <?php $this->addToolbar(); ?>
                </div>
            </div>
            <ul class="nav nav-tabs margin-bottom fullwidth" id="myTab" role="tablist">
                <li class="nav-item"><a href="#home" role="tab" data-bs-toggle="tab" class="nav-link active">
                        <?php echo \Joomla\CMS\Language\Text::_('JDETAILS', true); ?>
                    </a></li>
                <?php if ($user->authorise('core.admin', 'com_secretary'))
                {
                    ?>
                    <li class="nav-item"><a href="#permission" role="tab" data-bs-toggle="tab" class="nav-link">
                            <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PERMISSIONS', true); ?>
                        </a></li>
                <?php } ?>
            </ul>
                ...
                <div class="tab-pane active" id="home">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            ?>
                            <?php if ($this->item->extension == 'subjects' || $this->item->extension == 'products')
                            {
                                ?>
                                <hr>
                                <div class="col-md-4">
                            ...
                            <div class="control-group">
                                ...
                                <div class="select-arrow select-arrow-white margin-bottom">
                                    <select class="jform_parent_id" name="jform[parent_id]">
                                        <?php echo \Joomla\CMS\HTML\HTMLHelper::_('select.options', $this->folders, 'id', 'title', $this->item->parent_id, true); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="secretary-desc margin-bottom">
                                    <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FOLDER_NUMBER_DESC'); ?>
                                </div>
                            </div>
                            <div class="control-group">
                    ...
                    <div class="fullwidth">
                        <div class="col-md-12">
                            ...
                            <div class="field-add-container clearfix">
                                ...
                                <div id="field-add" counter="<?php echo 0 + $this->datafields['count']; ?>"><span
                                        class="fa fa-plus"></span>
                                    <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_NEW'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
