...
<div class="secretary-main-area entry-default">
    ...
    <div class="secretary-toolbar fullwidth">
        <div class="secretary-title">
            <span><a href="<?php echo Secretary\Route::create('folders'); ?>"> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FOLDERS'); ?></a>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span>
            <span><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FOLDER'); ?></span>
			<?php 
            if ($this->checkedOut == false && (\Secretary\Helpers\Access::edit('folder',$this->item->id,$this->item->created_by)))
            {
                ?>
            <a class="btn btn-saveentry" href="index.php?option=com_secretary&task=folder.edit&id=<?php echo $this->item->id;?>&extension=<?php echo $this->item->extension;?>"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOOLBAR_EDIT'); ?></a>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="home">
            ...
            <div class="fullwidth">
                ...
                <div class="col-md-3">
                    <div class="control-group">
                        <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EXTENSION'); ?></label></div>
                ...
                <div class="fields-items form-horizontal">
                    <?php if (!empty($this->item->fields) && ($fields = json_decode($this->item->fields, true)))
                    {
                        ...
                        <?php foreach ($fields as $field)
                        {
                            ...
                            <div class="control-group">
                                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_($field[1]); ?></label></div>
