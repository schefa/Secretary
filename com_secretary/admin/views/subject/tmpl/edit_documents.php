...
<table class="table table-hover">
    <thead>
        <tr>
            <td></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_CREATED'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_NR'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_NETTO'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TAX'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOTAL'); ?></td>
            <td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_STATUS'); ?></td>
        </tr>
    </thead>
	<tbody>
        <?php
        ...
        <tr>
            ...
            {
                ?>
                <a class="hasTooltip" data-original-title="<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SHOW'); ?>" title="<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SHOW'); ?>" href="<?php echo Secretary\Route::create('document', array('id' => $item->id)); ?>"><i class="fa fa-newspaper-o"></i></a>
            ...
            <td><?php echo \Joomla\CMS\Language\Text::_($item->category_title); ?></td>
