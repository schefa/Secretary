...
$input = $app->input;
$assoc = \Joomla\CMS\Language\Associations::isEnabled();
...
<div class="pull-right">
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('subject.apply');"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOOLBAR_APPLY') ?></button>
	<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('subject.save');"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOOLBAR_SAVE') ?></button>
	<button class="btn" type="button" onclick="Joomla.submitbutton('subject.cancel');"><?php echo \Joomla\CMS\Language\Text::_('JCANCEL') ?></button>
</div>

<div class="clearfix"> </div>
<hr class="hr-condensed" />

<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&layout=modal&tmpl=component&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="subject-form" class="form-validate">
    ...
    <div class="fullwidth form-horizontal">
        ...
        <div class="col-md-6">
            ...
            <div class="control-group">
            <div class="control-label"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_IMAGE'); ?></div>
            <?php 
            if (!empty($this->item->upload))
            {
                ...
                <div class="upload-file-delete">
                    <input type="checkbox" name="deleteDocument" >&nbsp;<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DELETE');?>
            ...
            <p class="secretary-desc fullwidth"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT_SIZE_ALLOWED') .' '. \Secretary\Utilities\Number::human_filesize($documentSize) . 'B'; ?></p>
            <?php } ?>
            </div>
