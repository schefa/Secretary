...
<div class="row-fluid">
    ...
    <div class="col-md-6 document-summary">
        ...
        <table class="secretary-table">
        	...
        	<tr class="secretary-document-total">
            	<td></td>
            	<td><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOTAL');?>
                </td>
            	<td>
                </td>
            	<td>
    ...
    <div class="fullwidth">
        <a id="openRabattDialog" class="btn btn-white pull-right <?php if ($rabattCSS != 'none')
        {
            echo 'active';
                                                                 } ?>"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENT_RABATTDIALOG');?></a>
