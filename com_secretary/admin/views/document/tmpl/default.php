...
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_secretary&view=document&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="document-form" class="form-validate">

	<div class="secretary-main-area entry-default">
		
        <div class="margin-bottom">
        	<a class="btn btn-default" href="<?php echo Secretary\Route::create('documents'); ?>"><i class="fa fa-angle-double-left"></i> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_DOCUMENTS'); ?></a>
			<?php 
            if ($this->checkedOut == false && (\Secretary\Helpers\Access::edit('document',$this->item->id,$this->item->created_by)))
            {
                ?>
        	<a class="btn btn-default" href="index.php?option=com_secretary&task=document.edit&id=<?php echo $this->item->id; ?>"><i class="fa fa-edit"></i> <?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EDIT'); ?></a>
            <?php }?>
        </div>
        ...
        <ul class="nav nav-tabs fullwidth" id="myTab" role="tablist">
			...
			<?php if (true === $this->canDo->get('core.edit') && !empty($this->item->subject[5]))
			{
                ?>
            <li class="nav-item">
                <a class="nav-link" href="#email" role="tab" data-bs-toggle="tab"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EMAIL', true); ?></a>
            </li>
            <?php }  ?>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a onclick="window.print();return false;" class="nav-link" href="#" role="tab" data-bs-toggle="tab"><img src="<?php echo SECRETARY_MEDIA_PATH; ?>/images/document_print_preview-20.png" />&nbsp;<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRINT_THIS_PREVIEW'); ?>
                </a>
            </li>
            <?php if (\Secretary\Helpers\ERechnung::isAvailable($this->item))
            {
                ?>
                <li class="nav-item">
                    <a class="btn btn-link btn-erechnung" href="<?php echo Secretary\Route::create('document', array('format' => 'xrechnung', 'id' => $this->item->id)); ?>" target="_blank"><i class="fa fa-file-code-o"></i>&nbsp;<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_ERECHNUNG'); ?></a>
                </li>
            <?php } ?>
            <?php 
            if (COM_SECRETARY_PDF)
            {
                ?>
            <li class="nav-item">
                <a class="btn btn-link" data-joomla-dialog='{"popupType": "iframe", "src": "<?php echo Secretary\Route::create('document', array('format'=>'pdf', 'tmpl'=>'component', 'id'=> $this->item->id)); ?>"}'><img src="<?php echo SECRETARY_MEDIA_PATH; ?>/images/pdf-20.png" />&nbsp;<?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PDF_PREVIEW'); ?></a>
            </li>
            <?php }  ?>
        </ul>
...
<div class="fullwidth">
    <div class="col-md-6"> 
        <div class="fullwidth">
			<h3 class="title title-edit"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_SUBJECT');?></h3>
            <div class="control-group">
                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_ANREDE'); ?></label></div>
                <div class="fullwidth secretary-controls controls"><?php echo $this->item->subject[1] ?? ''; ?></div>
            </div>
            <div class="control-group">
                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_STREET'); ?></label></div>
                <div class="fullwidth secretary-controls controls"><?php echo $this->item->subject[2] ?? ''; ?></div>
            </div>
            <div class="control-group">
                <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_LOCATION'); ?></label></div>
        ...
        <div class="row">
        	<div class="col-md-6">
                <div class="control-group">
                    <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PHONE'); ?></label></div>
                    <div class="fullwidth secretary-controls controls"><?php echo $this->item->subject[5] ?? ''; ?></div>
                </div>
        	</div>
        	<div class="col-md-6">
                <div class="control-group">
                    <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EMAIL'); ?></label></div>
...
<div class="fullwidth margin-bottom">
	<hr>
    <div class="col-md-12">
		<h3 class="title title-edit"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCTS'); ?></h3>
		<?php $items = json_decode($this->item->items ?? '', true);?>
		<table class="table">
			<thead>
				<tr>
					<th><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_QUANTITY');?></th>
					<th><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_ENTITY');?></th>
					<th><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT_NO');?></th>
					<th><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_PRODUCT');?></th>
					<th class="right"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EINZELPREIS');?></th>
					<th class="right"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_STEUERSATZ');?></th>
					<th class="right"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_GESAMTPREIS');?></th>
				</tr>
			</thead>
			<?php if (!empty($items))
			{
    ...
    <div class="col-md-4 pull-right">
        ...
        <div class="control-group">
            <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TAX');?> (<?php echo \Joomla\CMS\Language\Text::_($taxTypesOptions[$this->item->taxtype]);?>)</label></div>
        ...
        <?php } ?>
        <div class="control-group">
            <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_TOTAL');?></label></div>
    ...
    <div class="col-lg-3">
        <div class="secretary-document-bottom">
            <div class="secretary-document-template">
                <div class="control-group">
                    ...
                    <div class="fullwidth secretary-controls controls"><?php 
                    if (isset($this->defaultTemplate->title))
                    {
                        echo $this->defaultTemplate->title;
                    }
                    else
                                                                       {
                                                       echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_NONE');
                    } ?></div>
                </div>
                <div class="control-group">
                    <div class="control-label"><label><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_EMAIL_TEMPLATE');?></label></div>
                    <div class="fullwidth secretary-controls controls">
                    <?php if (isset($this->emailTemplate->title))
                    {
                        echo $this->emailTemplate->title;
                    }
                    else
                    {
                        echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_NONE');
            ...
            <div class="secretary-document-zahlung">
                <div class="control-group">
                    ...
                    <div class="fullwidth secretary-controls controls"><?php echo \Joomla\CMS\Language\Text::_( $stateTitle ); ?></div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="fullwidth secretary-controls controls"><?php echo round($this->item->paid ?? 0, 2).' '. $this->item->currencySymbol; ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <?php } ?>
            ...
            <div class="fullwidth">
                <h3 class="title"><?php echo \Joomla\CMS\Language\Text::_('COM_SECRETARY_FIELDS'); ?></h3>
