...
class SecretaryModelProducts extends \Joomla\CMS\MVC\Model\ListModel
{
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item)
		{
            ...
            if (!$item->canChange)
            {
                    $item->canChange = $user->authorise('core.edit.state', 'com_secretary.product');
            }
    
            if (!$canSee)
            {
                    $canSee = $user->authorise('core.show.other', 'com_secretary.product.' . $item->id);
            }
