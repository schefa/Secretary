...
class SecretaryModelLocations extends \Joomla\CMS\MVC\Model\ListModel
{
    protected $app;
    private $extension;
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item)
		{
            ...
            if (!$item->canChange)
            {
                    $item->canChange = $user->authorise('core.edit.state', 'com_secretary.location');
            }
    
            if (!$canSee)
            {
                    $canSee = $user->authorise('core.show.other', 'com_secretary.location.' . $item->id);
            }
