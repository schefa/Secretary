...
class SecretaryTableLocation extends \Joomla\CMS\Table\Table
{
    /**
     * Class constructor
     *
    ...
    public function bind($array, $ignore = '')
    {
		...
		{
            $actions = \Joomla\CMS\Access\Access::getActionsFromFile(JPATH_ADMINISTRATOR . '/components/com_secretary/access.xml', "/access/section[@name='location']/");
            $default_actions = \Joomla\CMS\Access\Access::getAssetRules('com_secretary.location.' . $array['id'])->getData();
            $array_jaccess = array();
