...
<table class="table table-hover" id="entriesList">
    <thead>
        <tr>
            ...
            <th class='left'>
            <?php echo JHtml::_('grid.sort',  'COM_SECRETARY_FIELD_TYPE', 'a.type', $this->state->get('list.direction'), $this->state->get('list.ordering')); ?>
            </th>
            <th class='left'>
    ...
    <?php foreach ($this->items as $i => $item) : ?>
        <tr class="row<?php echo $i % 2; ?>">
            ...
            <td>
                <?php if ($canCheckin) : ?>
                    <a class="hasTooltip" data-original-title="<?php echo JText::_('COM_SECRETARY_CLICK_TO_EDIT'); ?>"  href="<?php echo JRoute::_('index.php?option=com_secretary&task=item.edit&id='.(int) $item->id .'&extension='.$this->extension ); ?>">
